...
namespace AdventOfCode.Test.Day14
{
    ...
    public class PartOneTests
    {
        ...
        {
            var a = new ChemicalReaction(new Chemical("A", 10), ("ORE", 10));
            var b = new ChemicalReaction(new Chemical("B", 1), ("ORE", 1));
            var c = new ChemicalReaction(new Chemical("C", 1), ("A", 7), ("B", 1));
            var d = new ChemicalReaction(new Chemical("D", 1), ("A", 7), ("C", 1));
            var e = new ChemicalReaction(new Chemical("E", 1), ("A", 7), ("D", 1));
            var fuel = new ChemicalReaction(new Chemical("FUEL", 1), ("A", 7), ("E", 1)); 
            _refinery = new Refinery(a, b, c, d, e, fuel);
            var actual = _refinery.GetOresForSingleFuel();
            actual.Should().Be(31);
        }
        ...
        {
            var a = new ChemicalReaction(new Chemical("A", 2), ("ORE", 9));
            var b = new ChemicalReaction(new Chemical("B", 3), ("ORE", 8));
            var c = new ChemicalReaction(new Chemical("C", 5), ("ORE", 7));
            var ab = new ChemicalReaction(new Chemical("AB", 1), ("A", 3), ("B", 4));
            var bc = new ChemicalReaction(new Chemical("BC", 1), ("B", 5), ("C", 7));
            var ca = new ChemicalReaction(new Chemical("CA", 1), ("C", 4), ("A", 1));
            var fuel = new ChemicalReaction(new Chemical("FUEL", 1), ("AB", 2), ("BC", 3), ("CA", 4));
            _refinery = new Refinery(a, b, c, ab, bc, ca, fuel);
            var actual = _refinery.GetOresForSingleFuel();
            actual.Should().Be(165);
        }
